...
/*void changeDicomToJpeg(std::string dicom, std::string jpeg)
{
    int end_of_string=dicom.length();
    for(int i=0;i<end_of_string-3;i++)
    {
        jpeg+=dicom[i];
    }
    jpeg+="j";
    jpeg+="p";
    jpeg+="g";
    jpeg="hahahahahahah.jpeg";
    std::cout<<"1:the name of JPEG is : "<<jpeg<<std::endl;
}*/
