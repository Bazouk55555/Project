...
pathDicom = "C:/Users/User/Desktop/Individual_project/Individual_project_programmation/Liver_API4/All_liver/TCGA-LIHC/TCGA-BC-A3KG/1.3.6.1.4.1.14519.5.2.1.8421.4008.303533339368406310446855637599/1.3.6.1.4.1.14519.5.2.1.8421.4008.807354510232772395197490232364"
...
for file in os.listdir(pathDicom):
	print i
	if i<10:
		name="C:/Users/User/Desktop/image_python/test00"+str(i)
	if i>10 and i<100:
		name="C:/Users/User/Desktop/image_python/test0"+str(i)
	if i>100:
	  	name="C:/Users/User/Desktop/image_python/test"+str(i)
